...
(function() {
  ...
  Uint8Array.prototype.int = function(size) {
    var byte, value, _i, _len, _ref;
    value = 0;
    _ref = this.subarray(0, size);
  ...
  Uint8Array.prototype.int8 = function() {
    return this.int(1);
  };

  Uint8Array.prototype.int16 = function() {
    return this.int(2);
  };

  Uint8Array.prototype.int32 = function() {
    return this.int(4);
  };

  Uint8Array.prototype.int64 = function() {
    return this.int(8);
  };
